...
plt.figure(1)
leg = []
ref_data = file_sensor_mat.read(directory, 100, 1800, experiment_num=1, fm=60, transient=True)
...
for i in np.arange(1,11,1):
    data = file_sensor_mat.read(directory, 100, 1800, experiment_num=i, fm=60, transient=True) #organize the output in a SimuData structure
