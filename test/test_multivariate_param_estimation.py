...
t_init2 = time.time()
opt_values2 = parameter_estimation.multivariate_pseudo_gs_estimator(directory, data_types.SensorData, 100, harm_comps,
                                                            [1000,1600], [0,3], 10, tol=1e-3)
print(f'[param_estimation] GS yielded opt. height diff. value in {time.time()-t_init2} s!')
print(f'[param_estimation] opt. height diff. = {opt_values2.opt_mult}')