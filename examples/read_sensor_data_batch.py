'''
This is an example file to guide on processing sensor (bench test) output batch data into the DSP4IM framework.
'''
...
if type(data) == data_types.BatchSensorData:
    ...
    raise TypeError(f'[read_sensor_data_batch] The variable is not a BatchSensorData structure, data type = {type(data)}!')
