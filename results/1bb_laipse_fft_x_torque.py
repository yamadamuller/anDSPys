...
n_periods = 600 #number of integer periods to extract from the currents
torque = 4 #N.m
data = file_mat.read(file, torque, fs = 50e3, n_periods=n_periods, exp_num=experiment, normalize_by=np.max) #organize the output in a LaipseData structure
